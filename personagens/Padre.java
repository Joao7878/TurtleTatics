...
import Jogo.funcionalidades.Main;
...
public class Padre extends Personagem {
  ...
  public int atkEspecial(Jogador inimigos, Jogador aliados) {
    ...
    if (numReal <= 0.25) {//Conversão realizada com sucesso
      JOptionPane.showMessageDialog(null, "O " + this.getNome() + " conseguiu converter o " + inimigos.getPersonagens().get(opcPersonagemInt).getNome());
...
// habilidade especial: Tenta converter um inimigo dentro do seu raio de ação em aliado
// permanentemente.
