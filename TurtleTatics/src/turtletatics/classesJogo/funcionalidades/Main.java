  ...
  public static void main(String[] args) throws IOException {
    ...
    while(!menu_escolha.equals("0")) {
      ...
      if(menu_escolha.equals("1")) {
        System.out.println("O jogo Juão Santos Tatics é um jogo em baseados em turnos. Antes do jogo, os jogadores declararão seus nomes e então revezarão para escolher 1 personagem cada da lista, até cada um ter 5. Após isso, o jogo começará, onde cada jogador escolherá um personagem para realizar uma ação. Essa ação poderá ser um movimento, para deslocar a peça escolhida, atacar, onde a vida do personagem alvo é subtraída pelo ataque do atacante menos a defesa do defensor, e finalmente poderá também usar a habilidade especial do personagem. Cada um dos 10 personagens tem uma habilidade especial. Essas são:");
